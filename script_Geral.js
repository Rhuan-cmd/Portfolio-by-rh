...
const Botao_Enviar_Email = document.getElementById("Enviar-Email");
const Area_Texto_Email = document.getElementById("area-de-texto");
const Campo_Email = document.getElementById("Email-Cara");
...
Botao_Enviar_Email.addEventListener("mouseenter", Mouse_Point);
Botao_Enviar_Email.addEventListener("mouseleave", Mouse_Normal);

Area_Texto_Email.addEventListener("mouseenter", Remove_Mouse);
Area_Texto_Email.addEventListener("mouseleave", Mouse_Normal);

Campo_Email.addEventListener("mouseenter", Remove_Mouse);
Campo_Email.addEventListener("mouseleave", Mouse_Normal);
