...
Pastas_Projetos.forEach((p, index) => {
    p.addEventListener("click", () => {
        switch (index) {
            ...
            case 1:
                window.open("https://rhuan-cmd.github.io/tigrinha/", "_blank");
                break;

            case 2:
                window.open("https://rhuan-cmd.github.io/infoGP.github.io/", "_blank");
                break;

            case 3:
                window.open("https://rhuan-cmd.github.io/Java-Coffee/", "_blank");
                break;
